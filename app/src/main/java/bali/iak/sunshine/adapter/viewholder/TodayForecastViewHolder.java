...
public class TodayForecastViewHolder extends RecyclerView.ViewHolder {
    ...
    public TodayForecastViewHolder(View itemView) {
        super(itemView);
        ButterKnife.bind(this,itemView);
    }

    public void bind(final ListItem data, Context context, final OnclickListener listener) {
        ...
        date.setText(data.getTodayReadableTime());
